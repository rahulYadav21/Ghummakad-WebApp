    ...
    return (
        <>
            <MDBContainer fluid className='tour__container'>
                <MDBContainer className='p-lg-5 p-md-5 p-sm-5 tour__container1'>
                ...
                <MDBContainer className='p-lg-5 p-md-5 p-sm-0 tour__container2'>
                ...
                <MDBContainer className='p-lg-5 p-md-5 p-sm-0 tour__container3'>
